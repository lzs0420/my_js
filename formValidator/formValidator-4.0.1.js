...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		var settings = 
		{
			...
			submitAfterAjaxPrompt : "",	//控件失去焦点后，触发ajax校验，没有返回结果前的错误提示
	...
	pageIsValid : function (validatorGroup)
	{
		...
		if(isValid)
		{
			...
			if(initConfig.submitOnce){
				...
				$.blockUI({   
					message: "<img src='"+sWebRootPath+"/Resources/images/loading.gif' /><h4><strong>请求正在提交中,请稍后....</strong></h4>"  
	...
	return this.each(function()
	{
		...
		{   
			...
			if(!$('body').data(settings[0].validatorGroup).alertMessage){
		        ...
		        //2014-09-25 姜杰修改    阻止文本为空默认的oncorrect状态
